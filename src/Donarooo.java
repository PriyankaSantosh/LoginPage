...
public class Donarooo {
	static{
		...
		driver.findElement(By.xpath("//input[@class='text-full form-control form-text required']")).sendKeys("test21");
		...
		*/
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("//li[text()='Applied Materials 03-May-2019']")).click();
		...
		*/
		...
		driver.findElement(By.xpath("//input[@id='edit-field-date-of-collection-und-0-value-datepicker-popup-0']")).sendKeys("14 Mar 2019");
