...
public class PartialDonar {
	static{
		...
		driver.findElement(By.xpath("//input[@id='edit-field-donor-registration-id-und-0-value']")).sendKeys("1960");//unique

		//driver.findElement(By.xpath("//input[@class='text-full form-control form-text required']")).sendKeys("Rose1");//unique
		driver.findElement(By.xpath("//input[@id='edit-field-donor-name-und-0-value']")).sendKeys("sumaG");//unique
		...
		*/
		...
		driver.findElement(By.xpath("//input[@id='edit-field-date-of-collection-und-0-value-datepicker-popup-0']")).sendKeys("7 Mar 2019");
		driver.findElement(By.xpath("//input[@id='edit-field-date-of-collection-und-0-value-timeEntry-popup-1']")).sendKeys("11:50pm");

		driver.findElement(By.xpath("//input[@id='edit-field-bag-no-und-0-value']")).sendKeys("5651");
		driver.findElement(By.xpath("//input[@id='edit-field-batch-no-und-0-value']")).sendKeys("5651");
		driver.findElement(By.xpath("//input[@id='edit-field-donor-segment-number-und-0-value']")).sendKeys("5651");
		...
		driver.findElement(By.xpath(" //li[text()=' 54542 A1 Neg @ kkk ']")).click();
		...
		WebElement ele7 = driver.findElement(By.xpath("//button[text()='Process']"));
