...
public class AutomaticConsumeForBag {
	static{
		...
		driver.findElement(By.xpath("//input[@id='edit-title']")).sendKeys("Triple CPDA SAGM 450ml");
		Thread.sleep(3000);
		...
		driver.findElement(By.xpath("//input[@class='text-full form-control form-text required']")).sendKeys("retest789112");//unique
		driver.findElement(By.xpath("//input[@id='edit-field-donor-name-und-0-value']")).sendKeys("retest789112");//unique
		...
		*/
		...
		driver.findElement(By.xpath("//input[@id='edit-field-donor-segment-number-und-0-value']")).sendKeys("retest789112");
