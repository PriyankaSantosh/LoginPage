...
public class Patient {
	static{
		...
		driver.findElement(By.xpath("//input[@id='edit-field-patient-name-und-0-value']")).sendKeys("Jaya");
		...
		driver.findElement(By.xpath("//input[@id='edit-field-ip-number-und-0-value']")).sendKeys("123");
