...
public class Trail {
		static{
			...
			driver.findElement(By.xpath("//input[@class='text-full form-control form-text required']")).sendKeys("dev1");
			driver.findElement(By.xpath("//input[@id='edit-field-donor-name-und-0-value']")).sendKeys("dev1");
			...
			*/
			...
			driver.findElement(By.xpath("//input[@id='edit-field-mobile-und-0-value']")).sendKeys("9876543211");
			...
			Thread.sleep(2000);
			driver.findElement(By.xpath("//li[text()='bannergattastg1 03-May-2019']")).click();
			...
			*/
			...
			driver.findElement(By.xpath("//input[@id='edit-field-date-of-collection-und-0-value-datepicker-popup-0']")).sendKeys("11 May 2019");
