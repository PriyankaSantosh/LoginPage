...
public class OutwardTransferNeg {
	static{
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//textarea[@id='edit-field-dc-bb-numbers-und-0-value']")).sendKeys("8198-16-17-FFP");
		
		WebElement ele11 = driver.findElement(By.id("edit-submit"));
		JavascriptExecutor executor11 = (JavascriptExecutor)driver;
		executor11.executeScript("arguments[0].click();", ele11);
		System.out.println("Components are  expired");
}
}
