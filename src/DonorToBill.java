...
driver.findElement(By.xpath("//a[text()='Logout']")).click();
      ...
      String  dd11=dateFormat11.format(date11);
      System.out.println(dd11);
      
	          

		driver.findElement(By.xpath("//input[@class='text-full form-control form-text required']")).sendKeys(dd11);
      ...
      String  dd111=dateFormat111.format(date111);
      System.out.println(dd111);
      
      driver.findElement(By.xpath("(//input[@type='text'])[2]")).sendKeys(dd111);
